...
<head>
    ...
    <!-- Bootstrap Icon -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/font/bootstrap-icons.min.css">    <!-- Css Reset -->
...
<body>
    ...
    <nav class="navMenu navbar navbar-dark navbar-expand-lg align-items-center bg-primary fixed-top">
        <div class="container flex-row-reverse">
            <div class="d-flex align-items-center">
                ...
                <a class="navbar-brand text-white fw-bold fs-5" href="https://google.com" target="_blank"><img src="https://codeyad.com/assets/images/logo.png?v=LeGU9ZpNcH1zdFN4EVqXRwoS_Iaehq3X46AqXt2uWPk" alt="Codeyad"></a>
            </div>
    ...
    <div class="container mx-auto">
        <div class="row" style="margin-top: 10rem; margin-bottom: 5rem;">
            ...
            $stmt = $conn->query("SELECT * FROM `posts` LEFT JOIN `users` ON `posts`.`user_id` = `users`.`id`");
            ...
            foreach ($posts as $post) {
                ...
                echo '<div class="col-md-6 col-lg-3 mt-3 my_post">
                <div class="post">';
                ...
                echo '<h4 class=""><a href="#" class="post__title d-block">' .  $post['title']  . '</a></h4>';
                echo ' <p class="post__desc" style="height: 150px; overflow: hidden;text-overflow: ellipsis; white-space:wrap;"> ' . $post['text'] . '</p>';
                echo '<div class="info d-flex justify-content-between my-4" style="color: rgb(185, 188, 188); font-size: 12px;">';
                echo '<div>' . '<i class="bi bi-person "></i>' . '<span class="mx-1">' . $post['username'] . '</span>' . '</div>';
                echo '<div>
                            <i class="bi bi-calendar3"></i>
