...
<div class="main_wrap">
    ...
    <section class="container mb-2">
        <div class="row">
            <div class="col-xl-3 order-xl-0 order-1 mb-3"></div>
            ...
            <div class="col-xl-9  order-xl-1 order-0 mb-3">
                <div class="card">
                    ...
                    <div class="card-body p-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3 text-justify ">
                                <div class="d-flex align-items-center justify-content-start">
                                    <img src="<?= http('images/175333751310275637906881cea93da99.jpg') ?>" alt=""
                                         class="m-0 blogimg"
                                         style="height: 80px; width: 80px; border-radius: 40px;"/>
                                    <p class="mb-3 mx-3" style="font-size: 20px">بهنام</p>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-2 mb-3 text-justify">
                            </div>
                            <div class="col-lg-10 mb-3 text-justify">
                                <p class="" style="line-height: 2.5; font-size: 14px"><?= $article->image ?></p>
                            </div>
                        </div>
